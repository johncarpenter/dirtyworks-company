const { Icon, WorkOrder, AnnotatedComparison, ControlRegister, FitField, PullQuote, ProofLabel, CaseMetric, Button, CTABand, DiagnosticForm, ArticleRow, Declaration } = window.DirtyworksAiDesignSystem_9135ac;
    ...
    <Band tone="bone">
      ...
      <div style={{ display: "grid", gridTemplateColumns: "minmax(0,0.8fr) minmax(0,1.5fr)", gap: "var(--space-8)", alignItems: "start" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "10px" }}>
          ...
          <span style={{ fontFamily: "var(--font-mono)", fontSize: "11px", letterSpacing: "0.14em", textTransform: "uppercase", color: "var(--steel)" }}>Controls held, not promised</span>
        </div>
        <ControlRegister
